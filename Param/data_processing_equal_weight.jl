...
function SetExpData(nameExp,species,timePoints,abundance,IC,numOfDisc,weightComp)
  ...
  for t in 1:timeLength-1
    timePointsExtended[(t-1)*numOfDisc+1:t*numOfDisc+1]=range(timePoints[t],stop=timePoints[t+1],length=numOfDisc+1)
  end
...
function GetSpecies(speciesName,speciesOrder)
  ...
  output=Array{Vector{Int64}}(undef,lengthSpeciesName)
  ...
  for i=1:lengthSpeciesName
    ...
    output[i]=Vector{Int64}(undef,numOfMicrobe)
...
# Experiment "Mono" ------------------------------------------------------------
# Species name
singlen0=readdlm("/SNGO/Param/input/Mono/singlen0.csv",',')
singlen1=readdlm("/SNGO/Param/input/Mono/singlen1.csv",',')
singlen2=readdlm("/SNGO/Param/input/Mono/singlen2.csv",',')

# Time sequence
time0=readdlm("/SNGO/Param/input/Mono/time0.csv",',')
time1=readdlm("/SNGO/Param/input/Mono/time1.csv",',')
time2=readdlm("/SNGO/Param/input/Mono/time2.csv",',')

# Total abundance
singlegrowthn0=readdlm("/SNGO/Param/input/Mono/singlegrowthn0.csv",',')
singlegrowthn1=readdlm("/SNGO/Param/input/Mono/singlegrowthn1.csv",',')
singlegrowthn2=readdlm("/SNGO/Param/input/Mono/singlegrowthn2.csv",',')
...
# Experiment "Pair"-------------------------------------------------------------
# Species name
uniquename=readdlm("/SNGO/Param/input/Pair/uniquename.csv",',')

# Time sequence
TM=readdlm("/SNGO/Param/input/Pair/TM.csv",',')

# Total abundance
pairgrowthn0=readdlm("/SNGO/Param/input/Pair/pairgrowthn0.csv",',')
pairgrowthn1=readdlm("/SNGO/Param/input/Pair/pairgrowthn1.csv",',')
pairgrowthn2=readdlm("/SNGO/Param/input/Pair/pairgrowthn2.csv",',')

# Relative abundance
ABM=readdlm("/SNGO/Param/input/Pair/ABM.csv",',')
...
# PW22 Data---------------------------------------------------------------------
# Species name
relnames=readdlm("/SNGO/Param/input/PW22/relnames.csv",',')

# Time sequence
PW22time=readdlm("/SNGO/Param/input/PW22/PW22time.csv",',')

# Total abundance
absdata0=readdlm("/SNGO/Param/input/PW22/absdata0.csv",',')
absdata1=readdlm("/SNGO/Param/input/PW22/absdata1.csv",',')
absdata2=readdlm("/SNGO/Param/input/PW22/absdata2.csv",',')

# Relative abundance
relabm=readdlm("/SNGO/Param/input/PW22/relabm.csv",',')
...
# TM1 Data----------------------------------------------------------------------
# Species name
TMname=readdlm("/SNGO/Param/input/TM1/TMname.csv",',')

# Time sequence
TM1time=readdlm("/SNGO/Param/input/TM1/TM1time.csv",',')

# Total abundance
means_0=readdlm("/SNGO/Param/input/TM1/means_0.csv",',')
means_1=readdlm("/SNGO/Param/input/TM1/means_1.csv",',')
means_2=readdlm("/SNGO/Param/input/TM1/means_2.csv",',')

# Relative abundance
TM1rel=readdlm("/SNGO/Param/input/TM1/TM1rel.csv",',')
...
# L1O6 Data---------------------------------------------------------------------
# Species name
L1O6comm=readdlm("/SNGO/Param/input/L1O6/L1O6comm.csv",',')

# Time sequence
tL1O6 = [0 780 1425 2280 2910 3720 4310]./60

# Total abundance
hgc0=readdlm("/SNGO/Param/input/L1O6/hgc0.csv",',')
hgc1=readdlm("/SNGO/Param/input/L1O6/hgc0.csv",',')
hgc2=readdlm("/SNGO/Param/input/L1O6/hgc0.csv",',')

# Relative abundance
L1O6r=readdlm("/SNGO/Param/input/L1O6/L1O6r.csv",',')
...
# param0=readdlm("output/param6.csv",',')
